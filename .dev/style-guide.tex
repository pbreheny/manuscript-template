...
% Packages
\usepackage{graphicx}
\graphicspath{{../template/code/out/}}
\usepackage{natbib}
\usepackage{hyperref}
...
\begin{LTXexample}
\begin{figure}
  \includegraphics[width=\linewidth]{t-fig.pdf}
  \caption{The equal variance $t$-test 
  suffers from a lack of power when the
  large-variance group has larger sample
  size.}
  \label{fig:t-variance}
\end{figure}
\end{LTXexample}
...
\begin{table}
\centering
\caption{Simulation results for three
estimators.}
...
\midrule
MLE    & 0.02 & 0.31 & 0.31 \\
Ridge  & 0.05 & 0.22 & 0.24 \\
Lasso  & 0.01 & 0.22 & 0.22 \\
\bottomrule
\end{tabular}
\end{table}
\end{LTXexample}
